...
func ConnectDB(uri string) (*gorm.DB, error) {
	...
	return connectSQLite(uri)
}


func connectSQLite(uri string) (*gorm.DB, error) {
	...
	if err := db.AutoMigrate(&models.User{}, &models.Tenant{}, &models.UserTenant{}); err != nil {
		return nil, err
	}
...
// Resto de métodos (StartDBJanitor, CloseDB, CloseAllTenantDBs) con lógica común
// [Implementaciones similares a las existentes usando dm como receptor]
