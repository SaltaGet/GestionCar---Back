...
func GetAllMovementTypes(workplace string) (*[]models.MovementTypeLaundry, *[]models.MovementTypeWorkshop, error) {
	movementTypesLaundry, movementTypesWorkshop, err := repositories.Repo.GetAllMovementTypes(workplace)
	if err != nil {
		return nil, nil, models.ErrorResponse(500, "Error al actualizar cliente", err)
	}
